...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'djangocms_inherit_inheritpageplaceholder')
    ...
    models = {
        ...
        u'djangocms_inherit.inheritpageplaceholder': {
            'Meta': {'object_name': 'InheritPagePlaceholder', '_ormbases': ['cms.CMSPlugin']},
    ...
    complete_apps = ['djangocms_inherit']